const recettesParPage = 9;
    ...
    function afficherRecettes() {
        ...
        recettesPage.forEach((recette, index) => {
            ...
            if (isFavori(recette)) {
                favoriIcon.src = "../assets/images/on.png"; 
            }

            favoriIcon.addEventListener('click', function(event) {
                event.stopPropagation();
                ajouterAuxFavoris(startIndex + index, favoriIcon);
            });
    ...
    function isFavori(recette) {
        const favoris = JSON.parse(localStorage.getItem('favoris')) || [];
        return favoris.some(r => r.nom === recette.nom);
    }
    ...
    function ajouterAuxFavoris(index, favoriIcon) {
